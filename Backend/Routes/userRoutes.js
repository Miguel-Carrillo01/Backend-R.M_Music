...
const { registerUser, registerProducer, registerArtist, loginUsers, updateUser, getUser, recoverPassword, resetUpdatePassword, getUserProducer, getUserArtist, getRole, getAllParking, updateUserProducer, updateUserArtist, search, getBooking, getBookingById, getBookingByNitParking, createBooking, getUserSpaces, updateSpaceById, addSongsToArtist, deleteSongsArtist, updateSongsArtist} = require('../Controllers/userController');
